    ...
    <table border="0" width="100%" height="100%" bgcolor = #fcf7ef>
        ...
        <tr height="500px" bgcolor = #fcf7ef>
            <td align="center" valign="center" ><center><table border="0" style="color:#917461"><tr><td>
                <form name="add_product_form" method="post" action="add_product.php" accept-charset="utf-8" enctype="multipart/form-data">
                    <center><h2>ADD PRODUCT</h2></center> <br/><br/>
                    Name: <input type="text" name="p_name" /> <br/><br/>
                    Gemstone: <input type="text" name="p_gem" /> <br/><br/>
                    Type: <select name="p_type">
                            ...
                            Color: <input type="text" name="p_color" /> <br/><br/>
                    Birth: <select name="p_birth">
                                <option value = "">None</option>
                    ...
                    Price: <input type="text" name="p_price" style="width:100px;"/> Baht <br/><br/>
                    Stock: <input type="text" name="p_stock" style="width:100px;"/> EA <br/><br/>
                    <label for="p_pic">Picture: </label><input type="file" name="p_pic"/>
                    <input class="input" type="submit" value="ADD"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="adminShop.php">Back</a>
