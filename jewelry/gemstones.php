                ...
                <?php
                    ...
                    while($row = mysqli_fetch_array($result)){
                        ...
                        if($column==1){
                            ...
                            "<br/><i>\"".$row['g_affirmention']."\"</i><br/><br/>";?>

                            <a href="edit_gemstone_form.php?g_id=<?php echo $row['g_id'] ?>"><font color=#72a773>EDIT</font></a>
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="delete_gemstone.php?g_id=<?php echo $row['g_id'] ?>"><font color=#db0909>DELETE</font></a>
                            </center></td>
                        ...
                        if($column==3){
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="delete_gemstone.php?g_id=<?php echo $row['g_id'] ?>"><font color=#db0909>DELETE</font></a>
                            </center></td></tr><tr height="30" ></tr><tr valign="top">
