...
<body>
    <table border="0" width="100%" height="100%" bgcolor = #fcf7ef>
        ...
        <tr height="100px">
            <td align="center" valign="bottom" style="color:#917461;font-size:30px"><b>JEWELS AND GEMS FOR YOU</b>
            </td>
        </tr>
        <tr height="50px">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="PendentShop.php">Pendents</a> <br/> <br/>
            <br/></td>
        </tr>
        <tr height="30px">
            <td></td>
...
<?PHP
    ...
    if(isset($_GET['searching'])){
        if($_GET['searching'] != '') {
            if(isset($_GET['type_search'])) {
                ...
                if($_GET['type_search'] == 'p_name') {
                    ...
                    $sql = "SELECT * FROM products 
                            WHERE p_name like '%". $g_name ."%' AND p_type='Pendent' 
                            ORDER by p_price $type_char";
                }
                if($_GET['type_search'] == 'p_gem') {
                    $g_name = $_GET['searching'];
                    $sql = "SELECT * FROM products 
                            WHERE p_gem like '%". $g_name ."%' AND p_type='Pendent' 
                            ORDER by p_price $type_char";
                }
                if($_GET['type_search'] == 'p_color'){
                    $g_color = $_GET['searching'];
                    $sql = "SELECT * FROM products 
                            WHERE p_color like '%". $g_color . "%' AND p_type='Pendent' 
                            ORDER by p_price $type_char";
                }
                if($_GET['type_search'] == 'p_birth') {
                    $g_birth = $_GET['searching'];
                    $sql = "SELECT * FROM products 
                            WHERE p_birth like '%". $g_birth . "%' AND p_type='Pendent' 
                            ORDER by p_price $type_char";
                }
                if($_GET['type_search'] == 'p_zodiac') {
                    $g_zodiac = $_GET['searching'];
                    $sql = "SELECT * FROM products 
                            WHERE p_zodiac like '%". $g_zodiac . "%' AND p_type='Pendent' 
                            ORDER by p_price $type_char";
                }
            ...
            $sql = "SELECT * FROM products WHERE p_type='Pendent' ";
        }
    }
                ...
                <?php
                    ...
                    while($row = mysqli_fetch_array($result)){
                        ...
                        if($column==1){
                            ...
                            "<b>Price: ".number_format($row['p_price'])." baht</b><br/><br/></td>";}
                        ...
                        if($column==3){
                            ...
                            "Birth: ".$row['p_birth']."<br/>".
                            "Zodiac: ".$row['p_zodiac']."<br/><br/>".
                            "<b>Price: ".number_format($row['p_price'])." baht</b><br/><br/></td></tr><tr height=\"30\" ></tr><tr valign=\"top\">";
                            $column = 0;
                        }
                        $count +=1;
                    }
